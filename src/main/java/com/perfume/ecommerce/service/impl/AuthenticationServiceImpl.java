...
import com.perfume.ecommerce.exception.EmailException;
import com.perfume.ecommerce.exception.PasswordConfirmationException;
import com.perfume.ecommerce.exception.PasswordException;
import com.perfume.ecommerce.repository.UserRepository;
import com.perfume.ecommerce.security.JwtProvider;
import com.perfume.ecommerce.security.oauth2.OAuth2UserInfo;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private void sendEmail(User user, String subject, String template, String urlAttribute, String urlPath) {
        ...
        attributes.put(urlAttribute, frontendProperties.getBaseUrl() + urlPath);
