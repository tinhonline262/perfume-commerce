INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price, payment_method, payment_status)
    VALUES (111, 'Wall Street 1', 'New York', '2021-02-06', 'test123@test.com', 'John', 'Doe', '1234567890', 1234567890, 1400000, 'COD', 'PENDING');

INSERT INTO order_item (id, amount, quantity, perfume_id) VALUES (111, 525000, 1, 2);
INSERT INTO order_item (id, amount, quantity, perfume_id) VALUES (222, 650000, 1, 4);
