...
import com.perfume.ecommerce.enums.AuthProvider;
import com.perfume.ecommerce.enums.Role;
import com.perfume.ecommerce.domain.User;
import com.perfume.ecommerce.repository.UserRepository;
import com.perfume.ecommerce.security.JwtProvider;
import com.perfume.ecommerce.security.oauth2.*;
...
import static com.perfume.ecommerce.util.TestConstants.*;
import static com.perfume.ecommerce.util.TestConstants.USER_EMAIL;
...
public class AuthenticationServiceImplTest {
    ...
    public void registerUser() {
        ...
        attributes.put("registrationUrl", frontendBaseUrl + "/activate/" + user.getActivationCode());

        assertNotNull(userCreated);
        assertNotNull(user.getActivationCode());
        assertTrue(CoreMatchers.is(user.getRoles()).matches(Collections.singleton(Role.USER)));
        verify(captchaValidator, times(1)).validate("");
    ...
    public void sendPasswordResetCode() {
        ...
        attributes.put("resetUrl", frontendBaseUrl + "/reset/" + user.getPasswordResetCode());
