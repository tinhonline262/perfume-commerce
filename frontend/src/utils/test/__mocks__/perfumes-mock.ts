...
export const mockReviews: Array<ReviewResponse> = [
    { id: 1, author: "Celia Nguyen", message: "Soft amber with a calm cedar finish.", rating: 4, date: "2021-05-08" },
    { id: 2, author: "Mara Ellison", message: "The opening is bright and settles close to skin.", rating: 5, date: "2021-05-08" },
    { id: 3, author: "Theo Laurent", message: "Balanced, warm and easy to wear.", rating: 5, date: "2021-05-08" }
];
...
export const perfumeErrorData: PerfumeErrors = {
    ...
    inventoryError: "Fill in the input field",
