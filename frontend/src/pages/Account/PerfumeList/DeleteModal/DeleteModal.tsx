...
const DeleteModal: FC<PropsType> = ({ visible, deletePerfumeHandler, handleCancel, perfumeInfo }): ReactElement => {
    ...
    return (
        <Modal title={t('account.admin.delete_title', 'Delete perfume')} visible={visible} onOk={deletePerfumeHandler} onCancel={handleCancel}>
            <Row>
                <Col xs={24} md={12} className={"delete-modal-perfume-image-wrapper"}>
                    <img
                ...
                <Col xs={24} md={12}>
                    <Typography.Text>{t('account.admin.confirm_delete', 'Are you sure too delete?')}</Typography.Text>
