...
const PerfumeList: FC = (): ReactElement => {
    ...
    useEffect(() => {
        if (isPerfumeDeleted) {
            ...
            notification.success({
                message: t('account.admin.perfume_deleted', 'Perfume deleted'),
                description: t('account.admin.perfume_deleted_desc', 'Perfume successfully deleted!')
            });
        }
    }, [isPerfumeDeleted]);
    ...
    return (
        <div className="account-section-card">
            <ContentTitle title={t('account.admin.perfumes_list')} titleLevel={4} icon={<UnorderedListOutlined />} />
